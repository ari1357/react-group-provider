...
function ur() {
  if (Re)
    return D;
  Re = 1;
  var h = Pe, m = Symbol.for("react.element"), w = Symbol.for("react.fragment"), _ = Object.prototype.hasOwnProperty, A = h.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, I = { key: !0, ref: !0, __self: !0, __source: !0 };
  function x(y, l, O) {
    var d, g = {}, R = null, W = null;
    O !== void 0 && (R = "" + O), l.key !== void 0 && (R = "" + l.key), l.ref !== void 0 && (W = l.ref);
    for (d in l)
      _.call(l, d) && !I.hasOwnProperty(d) && (g[d] = l[d]);
    if (y && y.defaultProps)
      for (d in l = y.defaultProps, l)
        g[d] === void 0 && (g[d] = l[d]);
    return { $$typeof: m, type: y, key: R, ref: W, props: g, _owner: A.current };
  }
...
function sr() {
  return Te || (Te = 1, process.env.NODE_ENV !== "production" && function() {
    var h = Pe, m = Symbol.for("react.element"), w = Symbol.for("react.portal"), _ = Symbol.for("react.fragment"), A = Symbol.for("react.strict_mode"), I = Symbol.for("react.profiler"), x = Symbol.for("react.provider"), y = Symbol.for("react.context"), l = Symbol.for("react.forward_ref"), O = Symbol.for("react.suspense"), d = Symbol.for("react.suspense_list"), g = Symbol.for("react.memo"), R = Symbol.for("react.lazy"), W = Symbol.for("react.offscreen"), X = Symbol.iterator, Ce = "@@iterator";
    function Se(e) {
    ...
    function Ae(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === _ || e === I || Fe || e === A || e === O || e === d || De || e === W || xe || je || ke || typeof e == "object" && e !== null && (e.$$typeof === R || e.$$typeof === g || e.$$typeof === x || e.$$typeof === y || e.$$typeof === l || // This needs to include all possible module reference object
    ...
    var T = Object.assign, j = 0, ee, re, te, ne, ae, ie, oe;
    function ue() {
    }
    ...
    function Ze(e, r, t, n, o) {
      {
        ...
        t !== void 0 && (ve(t), a = "" + t), Je(r) && (ve(r.key), a = "" + r.key), Ge(r) && (v = r.ref, ze(r, o));
        for (u in r)
        ...
        return Xe(e, a, v, o, n, k.current, i);
      }
    }
    var J = P.ReactCurrentOwner, he = P.ReactDebugCurrentFrame;
    function C(e) {
      if (e) {
        var r = e._owner, t = L(e.type, e._source, r ? r.type : null);
...
Check the top-level render call using <` + t + ">.");
    ...
    function be(e, r) {
      {
        ...
        Ee[t] = !0;
        var n = "";
        e && e._owner && e._owner !== J.current && (n = " It was passed a child from " + E(e._owner.type) + "."), C(e), c('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', t, n), C(null);
      }
    }
    function _e(e, r) {
      {
    ...
    var ir = ar, or = nr;
    F.Fragment = _, F.jsx = ir, F.jsxs = or;
  }()), F;
}
...
const fr = (h) => {
  if (h.length === 1)
    return h[0];
  const m = h.shift(), w = h.shift();
  return fr([
    ({ children: _ }) => /* @__PURE__ */ Oe.jsx(m, { children: /* @__PURE__ */ Oe.jsx(w, { children: _ }) }),
    ...h
  ]);
};
export {
